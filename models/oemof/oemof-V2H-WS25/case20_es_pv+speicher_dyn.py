"""
oemof Energy System Model für PV + Batteriespeicher System
...
System-Topologie:
        Bus_electricity
            |
PV--------->|<---->home_battery (Batteriespeicher)
            |
Grid------->|
            |
excess------|
...
Komponenten:
- Bus_electricity:  Haushalts-Elektrizitätsbus (PV, Netz, Hausbedarf, Überschuss, Batterie)
...
Wichtige Hinweise:
1. Batteriespeicher optimiert Eigenverbrauch
2. Überschüssige PV-Energie wird gespeichert
3. Batterie kann Haushaltslast bei geringer PV-Erzeugung decken
"""
...
class SystemConfig:
    ...
    dump_filename: str = "case10_pv+battery"
    
    # Logging
    log_filename: str = "oemof_case10.log"
...
class EnergySystemModel:
    """
    Modelliert und optimiert ein Energiesystem mit PV und Batteriespeicher
    """
